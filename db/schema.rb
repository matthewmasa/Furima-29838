...
ActiveRecord::Schema.define(version: 20_201_001_080_247) do
  ...
  create_table 'addresses', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
               force: :cascade do |t|
